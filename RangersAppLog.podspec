Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |core|
        core.source_files = 'RangersAppLog/Core/Header/*.h'
  ...
  s.subspec 'UITracker' do |tracker|
   ...
   s.subspec 'Picker' do |picker|
        ...
        picker.public_header_files = 'RangersAppLog/Picker/Header/*.h'
